...
#' It can also be used to conveniently pblish your generated report and save the work you did on a notebook
...
#'   * the analysis plan, aka the extended  xlsform used to record relabelling, clean, indicator creation, question grouping, exploration settings
#'   * the source notebook
#' 
...
#'     The function automatically get the name of the notebook where it is runned from,
#'     using 
...
#'    * exploration_initial if your crunching is the very initial basic cleaning, relabelling of your data 
...
metadataanalysisplan <- riddle::resource_metadata(type = "attachment",
                                        url = paste0(stage, name, ridl, time, "_analysisPlan.xlsx"),
                                        name = paste0(stage, name, ridl, time, "_analysisPlan"),
                                        description = paste0("Analysis Plan to use with", 
                                                             stage, name, ridl, time,
                                                             ".html. Built using kobocruncher "),
                                        format = "xlsx",
                                        visibility =  visibility,
                                        file_type = "other",
                                        ## Revise here based on the name from your crunching report
                                        upload =  here::here(datafolder, form)
                                      )
if(republish == "yes") {
...
metadataanalysisscript <- riddle::resource_metadata(type = "attachment",
                                        url = paste0(stage, name, ridl, time, "_notebook.Rmd"),
                                        name = paste0(stage, name, ridl, time, "_analysisPlan"),
                                        description = paste0("Notebook ", 
                                                             stage, name, ridl, time,
                                                             ".html. Built using kobocruncher "),
...
```{r tests-kobo_ridl}
test_that("kobo_ridl works", {
  expect_true(inherits(kobo_ridl, "function")) 
})
```
