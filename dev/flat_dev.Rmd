...
## Clean rows - apply a filter
    
```{r function-kobo_clean_rows}
...
#' 
#' @export
# kobo_clean_rows <- function(datalist, 
...
```{r example-kobo_clean_rows}
# datalist <- kobo_data(datapath = system.file("data.xlsx", package = "kobocruncher") )
# nrow(datalist[[1]])
# datalist <- kobo_clean_rows(datalist,
...
```{r tests-kobo_clean_rows}
#test_that("kobo_clean_rows works", {   expect_true(inherits(kobo_clean_rows, "function"))})
```



## Cleaning values: categories & outliers

 


```{r function-kobo_clean_values}
...
#'  
#'  To address those situation, the kobo_clean_values function is building, if not set-up,  a cleaning log 
...
kobo_clean_values <- function(datalist,
                       dico) {
...
```{r examples-kobo_clean_values}
# dico <- kobo_dico( xlsformpath = system.file("sample_xlsform.xlsx", package = "kobocruncher") )
# datalist <- kobo_data(datapath = system.file("data.xlsx", package = "kobocruncher") )
# 
# kobo_clean_values(datalist = datalist,
#                    dico = dico,
