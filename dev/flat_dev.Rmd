...
#' @title Crunch a variable, used in conjunction with the analysis plan 
#' @param datalist An object of the "datalist" class as defined in kobocruncher 
#' @param dico path to the xlsform file used to colllect the data
#' @export
...
```{r function-template_A_exploration}
...
```{r function-template_B_interpretation}
...
```{r function-template_C_dissemination}
