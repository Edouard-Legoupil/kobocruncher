...
By default, charts will be generated and order by frequencies
...
In order to get those variables correctly represented, fill in the order column within the choices worksheet
