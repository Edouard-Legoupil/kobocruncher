...
## Afternoon session: 
  ...
  *  [08-Anonymising](08-Anonymising.html) In order to provide other people to work with the data, a first level of data anonymisation should be implemented

  *  [09-Interpreting](9-Interpreting.html) Once data are ready, time comes to facilitate  the interpretation of the data  
  
  *  [10-Publishing]10-Publishing.html) The final stage of the process encompasses the creation of data story telling content 
