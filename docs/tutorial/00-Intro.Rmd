...
## You do not need to be expert as soon as you follow recipes. 
 ...
 * .large[__Good practices__] are enforced through the package
 
 * Once the configuration file is written, run the report in Rstudio to get the output, this i.large[__increased productivity__]
 
 * No need to write R instructions. Indeed only a limited knowledge of R is required as most of the work is done in excel, which requires  .large[__minimum training__]: 
 
 * .large[__Working through iteration__] where you check the output and adjust as many time as needed the settings is a logic approach
