...
url <- paste0("https://ridl.unhcr.org/dataset/",params$ridl )
...
This data crunching report allows to quickly explore the results of the survey published in [RIDL](`r url `). It can be regenerated as needed based on the analysis plan you did set up. The objective of this report is to allow to quickly identify potential patterns in your dataset. A quick screening of this initial report should allow to select the most meaningful graphs.
